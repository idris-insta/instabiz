	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				note: "Runs whenever the customer has a Credit Limit (Instabiz Settings ▸ Block Orders Over Credit Limit). The 30-day overdue block has its own switch there.",
			},
			{"num":"165","title":"Settings for Each Module","desc":"Each module has its own settings page with its rules and standard terms: <b>IB Sales Settings</b> (approvals, credit checks, timelines, dormant reassignment, quotation / proforma / order terms), <b>IB Accounts Settings</b> (receipt account, IRN warning, banks, invoice declaration, interest, jurisdiction), <b>IB Stock Settings</b> (alerts, reorder draft, PO and challan terms), <b>IB HR Settings</b> (overtime, leave), <b>IB Print Settings</b> (letterhead, stamp, contact line) and <b>IB Messaging Settings</b> (WhatsApp).","link":"/app/ib-sales-settings","linkLabel":"Sales Settings","tags":"settings module rules terms conditions approver credit sla dormant overtime leave whatsapp print bank","steps":["Open the module's workspace and find the <b>Settings</b> card.","Change a value and Save. It applies from the next document or the next daily run.","Blank fields keep the previous built-in value."],"note":"The native ERPNext settings (Selling, Accounts, Stock, Buying, HR, Payroll) sit in the same Settings card."},
			{"num":"171","title":"One Tab per Module","desc":"Selling, Buying, Manufacturing, Stock and HR are one tab each. The Instabiz layout (dashboards, transactions, reports, help) is at the top; the standard ERPNext cards, charts and masters follow under the <b>ERPNext</b> heading, without repeating anything already above. The separate Instabiz, Instabiz Procurement, Instabiz Production, Instabiz Stock and Instabiz HR tabs are hidden.","link":"/app/selling","linkLabel":"Selling","tags":"workspace merge tab module selling buying procurement manufacturing production stock hr menu sidebar"},
			{"num":"172","title":"Financial Year: Switch, Compare, Close","desc":"The <b>FY</b> button in the top bar shows the financial year you are viewing; pick another year and reports and date filters open inside it (for you only, posting dates are not affected). The <b>Financial Year</b> page compares years side by side, creates next year, locks the books up to a date and starts year-end closing, with a close checklist.","link":"/app/ib-financial-year","linkLabel":"Financial Year","tags":"financial year fiscal year previous year switch lock books freeze year end closing period tally sap","steps":["Click <b>FY 2026-2027</b> in the top bar and choose a year.","Open any report: it opens in that year.","Year end: open Financial Year, clear the checklist, lock the books, then post the closing voucher."]},
			{"num":"173","title":"Day Book","desc":"Every accounting voucher for a day or period, one line each: type, number, party, accounts, debit, credit, narration. Like Tally's Day Book.","link":"/app/query-report/IB Day Book","linkLabel":"Day Book","tags":"day book daybook vouchers journal tally ledger daily"},
			{"num":"174","title":"Business Report (OTDS, live)","desc":"The OTDS FY Business Report, live from the books. Pick a view: <b>Monthly Summary</b> (sales, GST, net invoiced, collections, invoices, parties, collection %), <b>Party-wise</b>, <b>Collection Status</b> (outstanding, days overdue, overdue amount, credit limit, over-limit flag), <b>Item-wise</b> (sales, share, qty, parties, peak month), <b>Item Monthly</b> (top 50), <b>Party Monthly</b> (top 30), <b>State-wise</b>, <b>Salesperson-wise</b>. Opens in the financial year picked in the top bar.","link":"/app/query-report/IB Business Report","linkLabel":"Business Report","tags":"otds business report monthly party wise item wise state salesperson collection outstanding fy annual","steps":["Pick the View.","Change Financial Year, or set From / To for any period.","Filter by Party, Handled By or State.","Export with the report menu or tick rows and Export Selected (PDF)."],"note":"Sales = submitted Sales Invoices (returns reduce sales). Collections = payments and journal receipts. Outstanding = the party's ledger balance on the To Date."},
			{"num":"175","title":"Party Ledger (OTDS party account)","desc":"One customer's account the OTDS way: opening balance, every invoice opened into its lines (challan, description, width, length, qty/pkg, pkgs, qty, rate, amount), invoice total and GST, receipts, returns, running balance, transport and LR number, closing balance.","link":"/app/query-report/IB Party Ledger","linkLabel":"Party Ledger","tags":"otds party ledger account statement customer balance challan lr transport running balance"},
			{"num":"176","title":"Daily Production Report (DPR)","desc":"The Daily Production Report fills itself from production. When a stage is completed on the Production page, the Complete Stage dialog asks that stage's DPR numbers (shafts, logs, cartons, film / adhesive microns, drum…), pre-filled from the run, and an <b>IB DPR Entry</b> line is created with the machine, operator, jumbo, item, size, brand, times and output already in. The line works out the same numbers as the DPR sheet: coating consumption and roll weight, slitting SQM per carton and pcs per shaft, rewinding metres and SQM, cutting pcs per log, silicon pcs per drum, packing total pcs. <b>IB DPR Sheet</b> shows the day like the workbook: Summary (MAIN) and one view per stage with totals.","link":"/app/query-report/IB DPR Sheet","linkLabel":"DPR Sheet","tags":"dpr daily production report coating slitting rewinding cutting silicon packing shafts logs jumbo film adhesive","steps":["Production → complete a stage as usual.","Check or fill the DPR numbers in the Complete Stage dialog and press Complete.","Open DPR Sheet for the day. Managers can use Fill from Production to add lines for earlier completions.","A run outside a work order can still be added with New DPR Line."],"note":"Silicon is now a production stage too (sealant items route Silicon → Packing)."},
			{"num":"177","title":"Sales Incentive (COMM ACC, live)","desc":"Incentive is worked out automatically from each sales person's own orders (invoices once billing moves to invoices): net sale = sale without GST, then paid slab by slab on their scale — Sales Executive ₹2.5 L bands, Area Sales Manager ₹5 L, Sales Manager and Export Sales Manager ₹10 L; 0 / 0.25 / 0.5 / 0.75 / 1 %, last band open. The scale comes from the person's role (Sales Manager → Sales Manager, team leader → Area Sales Manager, other sales users → Sales Executive) unless set on their User record. The Sales Incentives page and <b>IB Incentive Statement</b> show it; on the 1st of each month everyone gets a notification with last month's incentive.","link":"/app/query-report/IB Incentive Statement","linkLabel":"Incentive Statement","tags":"incentive commission slab sales executive area sales manager net sale gst receivable comm acc"},
			{"num":"178","title":"Stock Working (jumbo SQM ledger)","desc":"<b>IB Stock Working</b> is the F STOCK WORKING sheet from the stock ledger, item-wise and warehouse-wise. Summary: each material in each warehouse — microns, colour, jumbo width × length, SQM per roll, stock in SQM and in jumbo rolls, with an all-warehouses line. Ledger: pick a material (and warehouse) to see every movement with challan, party, width, length, qty/ctn, ctns, SQM in / out and running stock.","link":"/app/query-report/IB Stock Working","linkLabel":"Stock Working","tags":"stock working jumbo sqm ledger rolls bopp masking film"},
			{"num":"179","title":"Range, Pricing, Idle Stock, Reorder Rhythm, Cross Sell","desc":"<b>Range Review</b>: per item / family / colour — sales, share, buyers, stock, months of cover and a call (Reorder now, Healthy, Order less, Tail, Dead). <b>Price Realisation</b>: low / median / high rate per item and the money lost selling under the median, per item or per customer. <b>Idle Stock</b>: money standing still — dead and overstocked lines ranked by value. <b>Reorder Rhythm</b>: customers late against their own usual gap between orders. <b>Cross Sell</b>: families each customer doesn't buy yet and which families sell together.","link":"/app/query-report/IB Range Review","linkLabel":"Range Review","tags":"range review reorder discontinue price realisation discount leakage idle dead stock overstock reorder rhythm cross sell family basket"},
			{"num":"180","title":"Enquiries from IndiaMART and the website","desc":"Open <b>IB Lead Capture Settings</b>, paste the IndiaMART CRM key and tick <b>Pull IndiaMART enquiries</b>. New enquiries come in as Leads every 15 minutes (source IndiaMART, product and message on the Lead). If the same mobile or email is already a Lead, the enquiry is added to that Lead's timeline and its owner gets a bell instead of a duplicate. For the website form, tick <b>Accept enquiries from the website</b>, press <b>New token</b> and give the web developer the capture link and token shown on the page. <b>Assign to</b> picks who gets new enquiries while round-robin is off.","link":"/app/ib-lead-capture-settings","linkLabel":"Lead Capture Settings","tags":"indiamart website enquiry lead capture web form justdial tradeindia"},
			{"num":"181","title":"Scan a purchase bill","desc":"Purchase Invoice list → <b>Scan Bill</b> (or IB Document Intake, type Purchase Invoice). Attach the photo or PDF of the supplier bill, pick the Location, Save, <b>Run OCR</b>, then <b>Extract</b>. The supplier is found by its GSTIN. With the Claude key the lines are read too and <b>Convert to Draft</b> makes a draft Purchase Invoice with the bill attached; without it the supplier, bill no, bill date and total are read and Convert opens a new Purchase Invoice with those filled in, and you add the lines there.","link":"/app/purchase-invoice","linkLabel":"Purchase Invoice","tags":"scan bill ocr purchase invoice supplier gstin document intake photo"},
			{"num":"182","title":"Bank file for salaries and vendor payments","desc":"<b>IB Bank Payment File</b>: pick Salary (month) or Vendor (dates). The table lists every payee with account number and IFSC and says why a line is left out. <b>Download Bank File</b> writes the HDFC bulk-upload CSV: HDFC accounts as internal transfer, ₹2 lakh and above as RTGS, the rest NEFT. Salary uses the bank details on the Employee; vendor payments use the Bank Account on the Payment Entry. Check the first file with the bank before uploading real payments.","link":"/app/query-report/IB Bank Payment File","linkLabel":"Bank Payment File","tags":"bank file bulk payment salary neft rtgs hdfc upload vendor payment"},
			{"num":"183","title":"Export to Tally","desc":"<b>IB Tally Export</b>: pick the dates (and a voucher type if you want only one). The table shows every voucher as it will go into Tally — Sales, Purchase, Receipt, Payment, Contra or Journal — and whether it balances. <b>Download Tally XML</b> writes the file; in Tally use Import → Transactions. With <b>Include ledger masters</b> the file also creates the ledgers (parties under Sundry Debtors / Creditors). Rename ledgers to match your Tally names in <b>IB Tally Export Settings</b>.","link":"/app/query-report/IB Tally Export","linkLabel":"Tally Export","tags":"tally export xml import accountant vouchers ledgers"},
			{"num":"184","title":"Mobile check-in with selfie and location","desc":"On <b>/checkin</b> the phone camera opens when you tap Check In / Check Out and the photo is kept on the Employee Checkin with the location. In <b>IB HR Settings → Mobile Check-in</b>: Selfie Off / Optional / Required, whether location is required, and an allowed distance from the office (with the office latitude, longitude for Maharashtra, Gujarat and Tamil Nadu). The check-in shows how far from the office it was taken; outside the allowed distance it is refused.","link":"/app/ib-hr-settings","linkLabel":"HR Settings","tags":"checkin selfie gps location geofence attendance mobile photo"},
			{"num":"185","title":"GST inbox, job work and quality at receipt","desc":"Finance: <b>GST Inbox (IMS)</b> to accept or reject supplier invoices before filing, and <b>GSTR-2B Reconciliation</b>. Buying: <b>Job Work (Subcontracting Order)</b> and <b>Job Work Stock (ITC-04)</b> for material sent to job workers, and <b>Quality Inspection</b> (tick Inspection Required before Purchase on an Item to make it compulsory at the GRN).","link":"/app/buying","linkLabel":"Buying","tags":"ims gst inbox gstr 2b job work subcontracting itc-04 quality inspection grn"},
			{"num":"186","title":"Customer complaints","desc":"<b>IB Support Ticket</b> (Complaints): customer, what it is about (order / challan / invoice, item, batch or roll), type and priority. The owner is the customer's sales person. Priority sets the deadlines (Urgent: respond 2 h, resolve 8 h; High 4 / 24; Medium 8 / 48; Low 24 / 96). A complaint needs a Root Cause before it can be Resolved; Credit Note from the ticket. Open complaints lower the customer health score. Past-deadline tickets are flagged every morning and the owner and Sales Managers are told. Customers can raise tickets themselves on /portal.","link":"/app/ib-support-ticket","linkLabel":"Complaints","tags":"complaint ticket quality issue return root cause sla customer service"},
			{"num":"187","title":"Customer portal (/portal)","desc":"Customer → Actions → <b>Portal Login</b>: enter the customer's email; the app makes their login and gives a set-password link with a WhatsApp button. On <b>/portal</b> the customer sees orders with production progress (stage by stage), invoices and dues, statement PDF, quotations, their last rates, technical documents for items they buy, and their complaints. They can download PDFs, raise a complaint and ask for a reorder (both come to you as tickets). They only ever see their own account.","link":"/portal","linkLabel":"Portal","tags":"portal customer login self service statement orders reorder"},
			{"num":"188","title":"Gate pass","desc":"<b>IB Gate Pass</b>: every vehicle in or out — Delivery, Purchase Receipt, Branch Transfer, Returnable, Non-Returnable, Job Work, Sample. From a submitted Delivery Note, Purchase Receipt, Stock Entry or Sales Invoice use Create → Gate Pass: party, vehicle, LR and items are copied. Returnable / job work / sample passes stay Open until security presses <b>Record Return</b> for what came back (Partly Returned → Returned). Overdue returnables are reported to stock managers every morning.","link":"/app/ib-gate-pass","linkLabel":"Gate Pass","tags":"gate pass security vehicle returnable inward outward job work"},
			{"num":"189","title":"Branch transfer (dispatch → in transit → receive)","desc":"Stock Entry list → <b>Branch Transfer</b>: from warehouse, to warehouse, items, vehicle, LR. It makes a transfer into Goods In Transit; submit it (make the e-way bill on it if needed). At the other branch open it and press <b>Receive at …</b> — a receipt into the destination is prepared; change quantities if short. <b>IB Goods In Transit</b> lists everything on the road with value and days.","link":"/app/query-report/IB Goods In Transit","linkLabel":"Goods In Transit","tags":"branch transfer stock transfer in transit dispatch receive warehouse"},
			{"num":"190","title":"Import landed cost","desc":"On <b>IB Container Import</b> enter the invoice currency and exchange rate, customs duty, freight, clearing and other charges (IGST on import is input credit — leave it out). Charges are spread over the lines by value (or by qty) and each line gets a Landed Rate; stock is received at that rate.","link":"/app/ib-container-import","linkLabel":"Container Import","tags":"import landed cost customs duty freight exchange rate container"},
			{"num":"191","title":"Employee loans and salary advances","desc":"<b>IB Employee Loan</b>: employee, amount, number of instalments, first deduction month. On submit each month's instalment is added to that month's salary as a deduction (component Loan Recovery). <b>Pay Out</b> makes the Payment Entry; <b>Skip a Month</b> moves one instalment to the end. Instalments are marked Deducted once the salary slip is submitted; the loan closes when the balance is nil.","link":"/app/ib-employee-loan","linkLabel":"Employee Loans","tags":"loan advance salary advance emi deduction payroll employee"},
			{"num":"192","title":"Item documents (TDS / SDS / COA)","desc":"<b>IB Item Document</b>: upload a technical data sheet, safety data sheet, certificate of analysis or test report per item with a version; the newest is Current. On a Quotation / Sales Order / Delivery Note use Create → <b>Attach Item Documents</b> so they go out with the email. Item → Documents lists them; customers download them on /portal.","link":"/app/ib-item-document","linkLabel":"Item Documents","tags":"tds sds msds coa technical data sheet certificate item document"},
			{"num":"193","title":"Budgets, vendor prices, duplicate check, MRP plan","desc":"<b>IB Budget vs Actual</b>: set a Budget per cost center and expense account; the report shows month and year-to-date spend against it and Accounts Managers are told at 90 % and 100 %. <b>IB Vendor Price History</b>: rates paid per item and supplier (lines or by supplier). <b>IB Duplicate Check</b>: purchase bills with the same supplier and bill no / amount, payments with the same party and amount or reference — also warned on save. <b>IB MRP Plan</b>: raw material needed for open orders (via IB Production Recipe) against stock and open POs, with Create Draft Requests.","link":"/app/query-report/IB Budget vs Actual","linkLabel":"Budget vs Actual","tags":"budget expense vendor price history duplicate bill payment mrp plan raw material"},
			{"num":"194","title":"Production posts to stock","desc":"When a run's last stage is completed the app makes one Repack stock entry: the run's source material (source item × qty loaded, wastage included) and anything the finished item's IB Production Recipe lists (core, carton…) go out of the source warehouse, and the finished goods come in. Their cost is the material that went in. If something is short the entry is kept as a draft and the stock team is told; the run still completes. Cancelling the run reverses it. IB Stock Settings → Production → Stock: on/off, submit or draft, finished-goods warehouse per location.","link":"/app/ib-stock-settings","linkLabel":"Stock Settings","tags":"production stock repack raw material consumption finished goods receipt manufacture"},
			{"num":"195","title":"Branch and Department on every entry","desc":"Every ledger entry carries a Branch (Bhiwandi, Sarigram, Chennai — filled from the document's location or warehouse) and a Department (pick it on expenses, journals and payments). General Ledger, Trial Balance, Profit and Loss and Balance Sheet can all be filtered by Branch or Department.","link":"/app/query-report/General Ledger","linkLabel":"General Ledger","tags":"dimension branch department cost center profit center p&l balance sheet filter"},
			{"num":"196","title":"Maker / checker on journals and payments","desc":"An Accounts User saves a Journal Entry and presses <b>Send for Approval</b>; Accounts Managers get a bell and approve (it is submitted) or reject with a reason — on the entry or in <b>IB Pending Approvals</b>, which also lists advances on orders, leave, overtime and expense claims. The Pending Approvals card sits on the Finance, HR and Selling pages. IB Accounts Settings → Approvals: journals on/off, outgoing payments on/off, only above an amount.","link":"/app/query-report/IB Pending Approvals","linkLabel":"Pending Approvals","tags":"approval maker checker journal entry memorandum payment pending approvals dashboard"},
			{"num":"197","title":"Payment register, cash forecast, dormant accounts","desc":"<b>IB Payment Register</b>: receipts and payments for any dates by party, mode, bank, branch, sales person, day or month. <b>IB Cash Forecast</b>: next weeks' bank balance — customer dues by due date (pushed by how late each customer usually pays), cheques, supplier dues, salaries and running expenses; Documents view lists what's behind each number. <b>IB Dormant Accounts</b>: ledgers, customers or suppliers with no entry for N days and money still sitting in them.","link":"/app/query-report/IB Cash Forecast","linkLabel":"Cash Forecast","tags":"receipt register vendor payment register cash flow forecast dormant ledger suspense"},
			{"num":"198","title":"Sales forecast and campaigns","desc":"<b>IB Sales Forecast</b>: next months' sales by total, family, item, customer or sales person from the last three months and last year's seasonal pattern. <b>IB Campaign</b>: pick who (state, group, sales person, quiet for N days, ordered recently, bought a family, has dues, or leads by source / status), write the message with {name}, {sales_person}, {last_order_date}, {outstanding}, Build List, Send — email and WhatsApp API go out directly; with free WhatsApp each person gets ready links. Refresh Results shows the orders that followed.","link":"/app/ib-campaign","linkLabel":"Campaigns","tags":"forecast sales projection campaign whatsapp email marketing bulk"},
			{"num":"199","title":"Ageing buckets, top N, PF / ESIC, registers","desc":"AR, AP and Stock Ageing take your own buckets in the Ageing (days) filter, e.g. 15,30,45,60,90. The Business Report has Top N and Sale at least. <b>IB Statutory Returns</b> writes the PF ECR text file and the ESIC upload sheet for a salary month. <b>IB Complaints Analysis</b>, <b>IB Gate Pass Register</b> and <b>IB Loan Register</b> report on complaints, gate passes and loans. WhatsApp / email messages from a document now also carry the e-way bill no, LR and links to its public attachments.","link":"/app/query-report/IB Statutory Returns","linkLabel":"PF / ESIC","tags":"ageing buckets top n pf ecr esic return complaints gate pass loan register e-way bill lr attachment"},
			{"num":"200","title":"Factory or plain warehouse","desc":"Each Warehouse has a <b>Manufacturing</b> tick. Ticked (or a group above it ticked, e.g. GUJARAT - IB covers every floor): orders shipped from it go through production and finished goods are posted when a run completes. Not ticked: a plain warehouse — no production at all, the Delivery Note takes the stock out directly. To make a new floor or branch a factory, tick it on the Warehouse.","link":"/app/warehouse","linkLabel":"Warehouses","tags":"warehouse factory manufacturing enable production location floor"},
			{"num":"201","title":"Stock transfer between floors and branches","desc":"Stock Entry list → <b>Stock Transfer</b>. Floor to floor or sub-warehouse to sub-warehouse in the same premises: moved in one entry. To another branch: it goes into Goods In Transit and is received at the other end.","link":"/app/stock-entry","linkLabel":"Stock Entry","tags":"stock transfer floor sub warehouse internal transfer branch transit"},
			{"num":"202","title":"Container (consignment) profitability","desc":"On IB Container Import each line has a <b>Selling Price</b> (blank = the item's selling price list rate): the container shows Expected Sale Value, Expected Profit and Margin % against the landed cost. <b>IB Consignment Profitability</b> (or Profitability on the container) shows what actually happened: what was processed in production and what was sold as is (matched to containers oldest first), revenue, profit, margin and stock left at cost — per container or per line.","link":"/app/query-report/IB Consignment Profitability","linkLabel":"Consignment Profitability","tags":"consignment container profitability margin landed cost selling price import"},
			{"num":"203","title":"Promise date on a Sales Order","desc":"While you enter an order, the top of the form shows <b>Can deliver by …</b>, worked out line by line: in stock at this location (all floors) → dispatch next day; stock on its way from another branch → its arrival; factory location → the production simulator's finish date; otherwise the buying lead time. <b>Details</b> shows each line, <b>Use this date</b> sets Delivery Date. Red = the Delivery Date on the order is earlier than possible. Days are in Sales Settings (dispatch 1, transit 4) and Stock Settings (lead time).","link":"/app/sales-order","linkLabel":"Sales Orders","tags":"promise date delivery date available to promise atp stock transit production lead time"},
			{"num":"204","title":"Slitting Plan (least trim waste)","desc":"<b>IB Slitting Plan</b> takes every open order line that needs Slitting, groups them by jumbo / film (IB Production Recipe) and tries every Active jumbo batch of that film: widths are packed together (Σ widths ≤ jumbo width − edge trim, ≤ knife positions) and the jumbo that leaves the least trim wins; same trim → oldest batch first. <b>Create Run</b> starts that pass as a production run. If one jumbo can't cover the qty, the run takes the whole jumbo and the rest stays in the plan. Lines without a recipe or a jumbo in stock are listed with the reason.","link":"/app/query-report/IB Slitting Plan","linkLabel":"Slitting Plan","tags":"slitting plan trim waste jumbo width knife combine widths cutting optimisation"},
			{"num":"205","title":"Real cost of every roll","desc":"When a run finishes, its stock entry now carries machine time as well as material: hours of each stage × the machine's <b>Running Cost per Hour</b> (IB Machine; blank = Stock Settings default), booked to Expenses Included In Valuation. Finished rolls therefore carry jumbo landed cost + recipe items + machine time. <b>IB Roll Cost</b> shows material, machine time, cost per unit, average selling rate (last 180 days) and margin — per run or per item. Red = selling below cost.","link":"/app/query-report/IB Roll Cost","linkLabel":"Roll Cost","tags":"roll cost costing conversion cost machine hour labour margin per roll"},
			{"num":"206","title":"Wastage norms and alerts","desc":"Each machine has a <b>Wastage Norm %</b> (else Stock Settings default 3 %). When an operator completes a stage with real output below input and the wastage is above the norm, Factory Management get a bell naming the run, stage, machine and operator. <b>IB Wastage Analysis</b> shows wastage vs norm by machine, stage, operator, item group, item or month.","link":"/app/query-report/IB Wastage Analysis","linkLabel":"Wastage Analysis","tags":"wastage norm yield scrap alert operator machine"},
			{"num":"207","title":"Read an order (WhatsApp / email / PO)","desc":"Sales Order list → <b>Read Order</b>: paste the customer's message or attach their PO, pick the location. It is read (Claude when the key has credit, otherwise line rules: qty with a unit, @ rate, sizes), the customer is matched by name or GSTIN and each item by width mm, length m, micron, colour and what this customer bought before. Review on the intake and press Create Draft — nothing is submitted.","link":"/app/ib-document-intake","linkLabel":"Document Intake","tags":"read order whatsapp email po intake ocr ai match item size"},
			{"num":"208","title":"Morning briefing","desc":"9 AM daily bell (and email once an outgoing account exists) to System / Sales / Accounts Managers and Factory Management with only what needs action: late orders, runs on hold or not moving, stages above wastage norm, stock short for open orders, collections, customers owing above the limit, pending approvals and big customers gone quiet. With Claude credit, three 'act on first' lines go on top. Messaging Settings → Morning briefing (roles, limit) and <b>Preview / Send Briefing Now</b>.","link":"/app/ib-messaging-settings","linkLabel":"Messaging Settings","tags":"morning briefing daily summary exceptions manager alert ai"},
			{"num":"209","title":"Container landed cost (same as ICMS)","desc":"IB Container Import now costs a container exactly like ICMS: CIF = invoice + freight + insurance (invoice currency); landed ₹ = CIF × rate + duty (CIF ₹ × Duty %, or the Customs Duty ₹ you enter) + bank charge (CIF × bank margin ₹ per 1) + CHA + other. A new container is pre-filled with the ICMS defaults (freight 2000, duty 11 %, bank 0.50, CHA ₹1,50,000, extra ₹25,000 — Stock Settings) so change them to the real figures before submit.","link":"/app/ib-container-import","linkLabel":"Container Import","tags":"landed cost icms cif duty freight insurance bank margin cha container import"},
			{"num":"166","title":"Send a Document on WhatsApp or Email","desc":"Quotation, Sales Order, Delivery Note, Sales Invoice, Payment Entry, Customer and Purchase Order have <b>Send ▸ WhatsApp</b> and <b>Send ▸ Email</b>. The message is filled from a template and carries a PDF download link that expires after the days set in Instabiz Settings.","link":"/app/ib-message-template","linkLabel":"Message Templates","tags":"whatsapp email send share pdf template message customer supplier quotation invoice","steps":["Open the document and click <b>Send ▸ WhatsApp</b>.","Check the number and message, then click <b>Open WhatsApp</b> and press Send in WhatsApp.","For email, click <b>Send ▸ Email</b>; the PDF is attached."],"note":"WhatsApp uses free wa.me links today; the API section in Instabiz Settings is ready for a provider. Email needs an outgoing Email Account."},
			{"num":"167","title":"New Print Formats","desc":"IB Quotation, IB Sales Order (order confirmation), IB Proforma Invoice, IB Delivery Challan, IB Box Label, IB Statement of Account and IB Item Label share one layout: letterhead, location address and GSTIN, bill-to/ship-to, item dimensions, HSN tax summary, bank details and terms.","link":"/app/print-format","linkLabel":"Print Formats","tags":"print format quotation proforma challan box label statement of account item label letterhead bank terms","note":"Bank details come from the location warehouse (Bank Details), else Instabiz Settings. Default terms per document are set in Instabiz Settings ▸ Print."},
			{"num":"168","title":"Overtime Pay at the Regular Rate","desc":"Salary Structure Assignment shows Per Day Rate and Per Hour Rate beside the monthly base. Approving an IB Overtime Request adds hours × per-hour rate to payroll as an Additional Salary; rejecting it removes it again.","link":"/app/ib-overtime-request","linkLabel":"Overtime Requests","tags":"overtime ot rate per hour per day salary payroll additional salary","note":"Day basis (26, 30 or days in the month), hours per day and multiplier are in Instabiz Settings ▸ HR."},
			{"num":"169","title":"Leave Allocated Automatically","desc":"Every active employee gets Casual, Sick and Privilege leave for the financial year automatically on 1 April, and new joiners get a prorated share the day after they are added.","link":"/app/leave-allocation","linkLabel":"Leave Allocations","tags":"leave allocation casual sick privilege annual joiner prorated april","note":"Days per year are in Instabiz Settings ▸ HR. Existing allocations are never changed."},
			{"num":"170","title":"Repeat Orders, Price Hints and Weekly Reorder Draft","desc":"<b>Create ▸ Repeat Last Order</b> on a customer (or Repeat This Order on an order) opens a new draft copy dated today. Picking an item shows the price this customer last paid and the rate-card price. Every week a draft Material Request is prepared from Replenishment Suggestions for the purchase team.","link":"/app/sales-order","linkLabel":"Sales Orders","tags":"repeat order duplicate reorder last price rate card hint material request replenishment weekly"},
		],
	},
	{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				note: "Auto-assignment runs every night at 12 AM. Manually added cards (via Customer Board, including its Team tab) are not affected by the scheduler.",
			},
			{
		...
		items: [
			{
				...
				steps: [
					...
					"Customer Board's Team tab roster shows a sales target bar per user.",
				],
