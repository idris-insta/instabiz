...
const KB_SECTIONS = [
	...
	},
	{
		...
		items: [
			...
			{"num":"165","title":"Instabiz Settings — One Page for Business Rules","desc":"Approvers, credit checks, alert days, dormant-customer reassignment, receipt bank, print branding and terms, overtime basis, leave days and WhatsApp mode all live on one page instead of in code.","link":"/app/instabiz-settings","linkLabel":"Instabiz Settings","tags":"settings rules configuration approver threshold sla dormant cap overtime leave whatsapp print bank terms","steps":["Open <b>Instabiz Settings</b> (System Manager).","Change a value and Save. It applies from the next document or the next daily run.","Blank fields keep the previous built-in value."],"note":"Every change is kept in the page version history."},
