...
const KB_SECTIONS = [
	...
	},
	{
		...
		items: [
			...
			{"num":"176","title":"Daily Production Report (DPR)","desc":"Log each machine run in <b>IB DPR Entry</b> — stage Coating WB / HM / PVC, Slitting, Rewinding, Cutting, Silicon or Packing. The form shows only that stage's columns and works out the same numbers as the DPR sheet on save: coating film / adhesive / liner per SQM and per roll, roll weight and consumption; slitting SQM per carton, shafts per carton, pcs per shaft, balance pcs; rewinding total metres, SQM and balance metres; cutting pcs per log and balance pcs; silicon pcs per drum; packing total pcs. <b>IB DPR Sheet</b> shows the day like the workbook: Summary (MAIN) and one view per stage with totals.","link":"/app/query-report/IB DPR Sheet","linkLabel":"DPR Sheet","tags":"dpr daily production report coating slitting rewinding cutting silicon packing shafts logs jumbo film adhesive","steps":["Production → DPR Entry → New.","Pick the Stage (and Coating film for coating).","Fill machine, jumbo, item size and the run numbers; Save.","Open DPR Sheet for the day's summary or a stage sheet."],"note":"Silicon is now a production stage too (sealant items route Silicon → Packing)."},
			{"num":"177","title":"Sales Incentive (COMM ACC, live)","desc":"<b>IB Incentive Scale</b> holds the four scales from the incentive sheet (Sales Executive ₹2.5 L bands, Area Sales Manager ₹5 L, Sales Manager and Export Sales Manager ₹10 L; 0 / 0.25 / 0.5 / 0.75 / 1 %, last band open). Set each person's scale on their User record (Incentive Scale). <b>IB Incentive Statement</b> works out the month: sale, GST, unpaid (optional), net sale, incentive per slab and total; the Year view is the SALES sheet.","link":"/app/query-report/IB Incentive Statement","linkLabel":"Incentive Statement","tags":"incentive commission slab sales executive area sales manager net sale gst receivable comm acc"},
			{"num":"178","title":"Stock Working (jumbo SQM ledger)","desc":"<b>IB Stock Working</b> is the F STOCK WORKING sheet from the stock ledger. Summary: each material's microns, colour, jumbo width × length, SQM per roll, stock in SQM and in jumbo rolls. Ledger: pick a material to see every movement with challan, party, width, length, qty/ctn, ctns, SQM in / out and running stock.","link":"/app/query-report/IB Stock Working","linkLabel":"Stock Working","tags":"stock working jumbo sqm ledger rolls bopp masking film"},
